...
class Pegawai extends RestController
{
  ...
  {
    parent::__construct();
    $this->load->model('pegawai_model', 'mhs');
  ...
  {
    $data = [
      'id_pegawai' => $this->post('id_pegawai', true),
  ...
  {
    $data = [
      'id_pegawai' => $this->put('id_pegawai', true),
    ...
    $id = $this->put('id', true);
    if ($id === null) {
      $this->response(['status' => false, 'msg' => 'Masukkan ID pegawai yang akan dirubah'], RestController::HTTP_BAD_REQUEST);
    }
  ...
  public function index_delete()
  {
    ...
    if ($id === null) {
      $this->response(['status' => false, 'msg' => 'Masukkan ID pegawai yang akan dihapus'], RestController::HTTP_BAD_REQUEST);
    }
